...
from .views import create_appointment, success_reservation, error_reservation, list_availabilities, reserve_turn, AvailabilityAPIView
...
#API 
    path('availability/', AvailabilityAPIView.as_view(), name='availability_api'),
#    path('appointments/', list_availabilities, name='appointments'), # Añade esta línea
]
